            ...
            <div className="mx-auto max-w-7xl px-4">
                <div className="mx-auto max-w-3xl text-center">
                    ...
                    <div className="mt-6 flex justify-center">
                        <Link href="/services" className="rounded-full px-8 py-2.5 text-base/6 font-semibold bg-gray-800 hover:bg-gray-900 hover:border-transparent transition-colors text-green-300">
                            Nos services
                        </Link>
                    </div>
                </div>
